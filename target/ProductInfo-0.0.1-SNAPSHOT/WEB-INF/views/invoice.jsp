...
<body>
	...
	<div class="container">
					...
					<table class="table table-hover table-striped table-bordered">
						<thead>
							<tr>
								...
								<th class="bg-success">Item Cost</th>
								<th class="bg-success">Additional Cost</th>
							</tr>
						</thead>
						<tbody>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<h3 class="text-danger">Create Invoice:</h3><br/>
				<form action="invoice" modelAttribute="invoiceDetails" method="post">
				<div class="form-group">
						<label>Invoice Prefix :</label> <input class="form-control" type="text"
							placeholder="Enter invoice prefix" name="invoiceNumber"
							required />
					</div>
					<div class="form-group">
